...
import touch.nn.fuctional as F
...
ap.add_argument('--top_k', default=5, dest="top_k", action="store", default='cat_to_name.json')
ap.add_argument('--category_name', dest="category", action="store", default='cat_to_name.json')
